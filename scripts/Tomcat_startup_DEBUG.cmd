...
@REM ########################################################################################################
@REM set JAVA_OPTIONS=%JAVA_OPTIONS% -Xrunjdwp:transport=dt_socket,address=10171,server=y,suspend=n -Xmx512m -XX:MaxPermSize=256m -Dspring.profiles.active=dev -DENVIRONMENT=dev -Djavax.net.ssl.keyStore=C:\Users\keystore.jks -Djavax.net.ssl.keyStorePassword= -Djavax.net.ssl.password= -Djavax.net.ssl.trustStore=C:\Java\jdk1.8.0_65\jre\lib\security\cacerts -Dweblogic.security.SSL.trustedCAKeyStore=C:\Java\jdk1.8.0_65\jre\lib\security\cacerts  -Djavax.net.ssl.trustStore.password= -Dnbi.jpa.logging=SEVERE -Dweblogic.security.allowCryptoJDefaultJCEVerification=true
@REM ########################################################################################################
